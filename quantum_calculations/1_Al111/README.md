...
docker run --volume-driver local -v $PWD:/mnt --shm-size=1g -it --rm --user root cp2k/cp2k sh -c "umask 0000 && mpiexec -genv OMP_NUM_THREADS=2 -np 18 cp2k Al111_active_space.inp"
```
