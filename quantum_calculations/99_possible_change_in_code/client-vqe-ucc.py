...
if __name__ == "__main__":
    ...
    optimizer = L_BFGS_B()
    solver = StatefulVQE(estimator, ansatz, optimizer) #change to statevector calc, just define estimator (statevector etimation)
    ...
    if isinstance(integ.algo.solver, StatefulAdaptVQE):
        algo = GroundStateEigensolver(integ.algo.qubit_mapper, integ.algo.solver.solver) #define solver
