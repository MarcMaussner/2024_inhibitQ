...
python3 generate_input.py al_slab
python3 generate_input.py al_slab_inhibitor
python3 generate_input.py inhibitor

# Run CP2K calculations
run_cp2k Al_slab.inp
run_cp2k Al_slab_inhibitor.inp
run_cp2k inhibitor.inp
